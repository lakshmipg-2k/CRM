...
if(isset($_GET['delete'])){
   ...
   $ret= mysqli_query($con,"delete from  user where id='$delete_id' ") or die('query failed');
    if($ret)
	{
...
<a href="manage-users.php?delete=<?php echo $row['id'];?>"   class="btn btn-danger btn-xs btn-mini">Delete</a>
</form>
</td>
</tr>
<?php $cnt=$cnt+1; } ?>
...
<script>
	//Too Small for new file - Helps to tick all options in the table
